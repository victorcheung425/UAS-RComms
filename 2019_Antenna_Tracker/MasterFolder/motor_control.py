...
class dynamixel_control:
	...
	def start_serial(self):
		...
		self.ser.write('write 1 Torque_Enable 0 \r\n')
		self.ser.write('reboot 1 \r\n')
		self.ser.write('write 1 Operating_Mode 4 \r\n')
		self.ser.write('write 1 LED 1 \r\n')
		self.ser.write('write 1 Torque_Enable 1 \r\n')
		self.ser.write('write 2 Torque_Enable 0 \r\n')
		self.ser.write('reboot 2 \r\n')
		self.ser.write('write 2 Operating_Mode 4 \r\n')
		self.ser.write('write 2 LED 1 \r\n')
		self.ser.write('write 2 Torque_Enable 1 \r\n')
